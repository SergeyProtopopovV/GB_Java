...
//        Logger logger = Log.log(Task05.class.getName());
//        System.out.println(Arrays.toString(GetFilesNameInDir("seminar02")));
//        writeFileNamesToFile(".", "task05.txt");
//    }
//
//    public static String[] GetFilesNameInDir(String path) {
...
//        String[] arr = GetFilesNameInDir(outpath);
//        try {
